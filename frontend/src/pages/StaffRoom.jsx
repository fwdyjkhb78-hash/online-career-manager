...
import { Crown, MessageSquare, Users, Send, UserPlus, Shield, Trophy, Wallet, TicketIcon, UserX, CalendarDays, Building2, ShoppingCart, ArrowRight, Image, Globe, Copy, CreditCard } from 'lucide-react';
...
import ClubsBudgetChart from '@/components/staff/ClubsBudgetChart';
...
import NationalTeamsTab from '@/components/staff/NationalTeamsTab';
import DeduplicatePlayersTab from '@/components/staff/DeduplicatePlayersTab';
import SansLigueManagerTab from '@/components/staff/SansLigueManagerTab';
import PaypalConfigTab from '@/components/staff/PaypalConfigTab';
import BudgetRequestsTab from '@/components/staff/BudgetRequestsTab';
import AllPlayersTab from '@/components/staff/AllPlayersTab';
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Tabs defaultValue="messages" className="w-full">
          <TabsList className="bg-slate-900 border border-slate-800 w-full flex flex-wrap gap-1 h-auto p-2">
            ...
            <TabsTrigger value="national-teams" className="data-[state=active]:bg-slate-800 flex-col gap-1 py-2 px-3 h-auto text-xs">
              <Globe className="w-4 h-4" />
              <span>Sélections</span>
            </TabsTrigger>
            <TabsTrigger value="dedup" className="data-[state=active]:bg-slate-800 flex-col gap-1 py-2 px-3 h-auto text-xs">
              <Copy className="w-4 h-4" />
              <span>Doublons</span>
            </TabsTrigger>
            <TabsTrigger value="sans-ligue" className="data-[state=active]:bg-slate-800 flex-col gap-1 py-2 px-3 h-auto text-xs">
              <Building2 className="w-4 h-4" />
              <span>Hors-Ligue</span>
            </TabsTrigger>
            <TabsTrigger value="budget-requests" className="data-[state=active]:bg-emerald-500 flex-col gap-1 py-2 px-3 h-auto text-xs">
              <Wallet className="w-4 h-4" />
              <span>Recharges</span>
            </TabsTrigger>
            <TabsTrigger value="paypal-config" className="data-[state=active]:bg-blue-500 flex-col gap-1 py-2 px-3 h-auto text-xs">
              <CreditCard className="w-4 h-4" />
              <span>PayPal</span>
            </TabsTrigger>
            <TabsTrigger value="all-players" className="data-[state=active]:bg-violet-500 flex-col gap-1 py-2 px-3 h-auto text-xs">
              <Users className="w-4 h-4" />
          ...
          <TabsContent value="national-teams" className="mt-6">
            <NationalTeamsTab />
          </TabsContent>
          <TabsContent value="dedup" className="mt-6">
            <DeduplicatePlayersTab />
          </TabsContent>
          <TabsContent value="sans-ligue" className="mt-6">
            <SansLigueManagerTab />
          </TabsContent>
          <TabsContent value="budget-requests" className="mt-6">
            <BudgetRequestsTab currentUser={user} />
          </TabsContent>
          <TabsContent value="paypal-config" className="mt-6">
            <PaypalConfigTab />
          </TabsContent>
