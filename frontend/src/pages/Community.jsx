...
import { MessageSquare, Flame, Loader2, LogIn, Trophy, GraduationCap, TrendingUp, Wifi, Shield, Calendar, Globe } from 'lucide-react';
...
import NationalTeamsTab from '@/components/community/NationalTeamsTab';
const TABS = [
  ...
  { id: 'national', label: 'Sélections', icon: Globe },
];
...
export default function Community() {
  ...
  const handleTouchMove = (e) => {
    if (window.scrollY === 0 && pullDistance > 0) {
      const distance = e.touches[0].clientY - pullDistance;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950" style={{ transform: `translateY(${Math.min(pullDistance * 0.2, 60)}px)` }}>
        ...
        <div className="relative max-w-3xl mx-auto px-4 py-8 text-center">
          ...
          <div className="flex justify-center gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-500 text-sm md:text-base">Posts</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-white">{totalLikes}</p>
              <p className="text-slate-500 text-sm md:text-base">Likes</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-white">{totalComments}</p>
              <p className="text-slate-500 text-sm md:text-base">Commentaires</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              {userLoading ? null : user ? (
                ...
                <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6 text-center">
                  ...
                  <p className="text-slate-300 font-medium mb-4 text-sm md:text-base">Connectez-vous pour poster</p>
              ...
              {isLoading ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-slate-400 text-base md:text-lg">Soyez le premier à poster !</p>
                </div>
              ) : (
        ...
        {/* National Teams Tab */}
        {activeTab === 'national' && <NationalTeamsTab currentUser={user} />}
      </div>
    </div>
  );
}