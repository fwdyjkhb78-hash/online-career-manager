...
import {
  ...
  ChevronRight, Zap, Shield, Check, Loader2 } from
'lucide-react';
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            ...
            <>
                ...
                <Link to={createPageUrl('TransferMarket')} className="w-full sm:w-auto">
                  <Button size="lg" variant="outline" className="bg-[hsl(var(--foreground))] text-white px-6 py-5 text-base font-medium rounded-xl inline-flex items-center justify-center gap-2 whitespace-nowrap transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 border shadow-sm hover:text-accent-foreground h-10 border-slate-600 hover:bg-slate-800 sm:px-8 sm:py-6 sm:text-lg w-full sm:w-auto">
