...
export default function ManageUsersTab() {
  ...
  const assignClub = async ({ userId, oldClubId, clubId, clubName }) => {
    ...
    // Libérer l'ancien club si besoin
    if (oldClubId) {
      await base44.entities.Club.update(oldClubId, { manager_id: '', manager_name: '' });
    }
    // Assigner le nouveau club si besoin
    if (clubId) {
