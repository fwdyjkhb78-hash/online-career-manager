...
export default function CreatePost({ currentUser }) {
  ...
  const handleImage = (e) => {
    ...
    if (file) {
      // Redimensionner l'image à 16:9 (1920x1080 ou équivalent)
      ...
      reader.onload = (event) => {
        ...
        img.onload = () => {
          ...
          // Dimensions cibles 16:9
          const targetWidth = 1600;
          const targetHeight = 900;
          
          // Calculer le crop pour garder le ratio 16:9
    ...
    <form onSubmit={handleSubmit} className="bg-slate-800/60 border border-slate-700/50 rounded-2xl p-5 space-y-4">
      ...
      {imagePreview && (
        <div className="relative">
          <img src={imagePreview} alt="" className="rounded-xl w-full aspect-video object-cover" />
          <button
            type="button"
