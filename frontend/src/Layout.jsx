...
import {
  ...
  Menu, X, LogOut, User, ChevronDown, Crown, Swords, Bell, TicketIcon, Info, Globe, Settings } from
'lucide-react';
...
{ name: 'Sélections', page: 'NationalTeamSpace', icon: Globe, staffOnly: true },
...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-950/90 backdrop-blur-lg border-b border-slate-800 safe-area-top">
